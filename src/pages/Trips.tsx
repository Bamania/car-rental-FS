  ...
  return (
    <div className="min-h-screen w-full bg-[#18191C] text-white flex items-center justify-center font-mono">
      <div className="w-full max-w-md mx-auto px-6">
        ...
        <Card className="bg-[#232428] border-none font-mono">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 font-mono">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-3 py-2 bg-[#18191C] border border-gray-600 rounded-lg focus:outline-none focus:border-blue-500 text-white font-mono"
